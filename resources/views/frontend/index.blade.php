            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="{{asset('frontend/img/logo-v1.png')}}" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
...
<div id="services" class="services section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading  fadeInDown" >
                    <h6>Our Services</h6>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="menu">
                                    ...
                                    <div>
                                        <div class="thumb">
                                            <span class="icon"><img src="{{asset('frontend/img/service-icon-02.png')}}" alt=""></span>
                                            Food &amp; Life
                                        </div>
                                    </div>
                                    <div>
...
<div id="free-quote" class="free-quote">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-2  fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
...
<div id="portfolio" class="our-portfolio section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <div class="section-heading " data-wow-duration="1s" data-wow-delay="0.3s">
    ...
    <div class="container-fluid fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
        <div class="row">
            <div class="col-lg-12">
...
<div id="blog" class="blog">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 offset-lg-4  fadeInDown" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="section-heading">
                    <h6>Recent News</h6>
            ...
            <div class="col-lg-6 show-up fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="blog-post">
                    <div class="thumb">
...
<div id="contact" class="contact-us section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                <form id="contact" action="" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="contact-dec">
                                <img src="{{asset('frontend/img/contact-dec.png')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div id="map">
                            ...
                            <div class="fill-form">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="info-post">
                                            <div class="icon">
                                                <img src="{{asset('frontend/img/phone-icon.png')}}" alt="">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="info-post">
                                            <div class="icon">
                                                <img src="{{asset('frontend/img/email-icon.png')}}" alt="">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="info-post">
                                            <div class="icon">
                                                <img src="{{asset('frontend/img/location-icon.png')}}" alt="">
